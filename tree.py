...
if __name__ == '__main__':
    ...
    ID3desicionTree = ID3_createTree(dataset, labels_tmp1, testSet)
    C45desicionTree = C45_createTree(dataset, labels_tmp2, testSet)
    CARTdesicionTree = CART_createTree(dataset, labels_tmp3, testSet)

    treePlotter.showAllTrees(ID3desicionTree, C45desicionTree, CARTdesicionTree)
